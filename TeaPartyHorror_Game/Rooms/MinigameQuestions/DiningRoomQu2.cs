...
namespace TeaPartyHorror_Game.Rooms.MinigameQuestions
{
    internal class DiningRoomQu2 : Room
    {
        ...
        internal override void ReceiveChoice(string choice)
        {
            ...
            {
                case "1":
                    Console.WriteLine("The ghost decidedly is not impressed by your manners, and you swear you can see an angry, red glint in her eyes that    makes you shiver.");
                    Game.IncreaseFear(1);
                    Game.Transition<DiningRoomQu3>();
                    Console.WriteLine("'Now,' she begins once you have finished your meal, 'The two magic words?'");
                    Console.ForegroundColor = ConsoleColor.Magenta;
                    Console.WriteLine("Press 1 to say 'thank you'\t\tPress 2 to say 'screw you'");
                    Console.ForegroundColor = ConsoleColor.White;
                    break;
                case "2":
                    Console.WriteLine("The cook joins her hands and regards you happily as you continue forcing yourself to eat.");
                    Game.Transition<DiningRoomQu3>();
                    Console.WriteLine("'Now,' she begins once you have finished your meal, 'The two magic words?'");
                    Console.ForegroundColor = ConsoleColor.Magenta;
                    Console.WriteLine("Press 1 to say 'thank you'\t\tPress 2 to say 'screw you'");
