        ...
        internal override void ReceiveChoice(string choice)
        {
            ...
            switch (choice.ToLower())
            {
                case "1":
                    ...
                    Console.WriteLine("\nThe cook smiles at you. It's somewhere between sweet old granny and creepy.");
                    ...
                    break;
                case "2":
                    Console.WriteLine("\nThe ghost glares at you for your bad manners.");
                    Game.IncreaseFear(1);
                    Game.Transition<DiningRoomQu2>();
                    Console.WriteLine("\nYou are sleepy and cant remember your table etiquette in front of all that cutlery...");
                    Console.WriteLine("\nThe knife should be in the right hand and the fork in the left");
                ...
                default:
                    Console.WriteLine("\nThe cook waves a hand and a porcelain plate, and cutlery float over to your place at the table! It smells divine...");
